...
<head>
    ...
    <link rel="icon" href="img/cutmypic.png" >
    <!-- Bootstrap -->
    ...
    <div class="span12 text-center" >
      <div class="btn-group animated">
        ...
        <ul class="dropdown-menu">
          <li><a href="http://localhost/PORTFOLIOMERY/index.php?language=en#">en</a></li>
          <li><a href="http://localhost/PORTFOLIOMERY/index.php?language=fr#">fr</a></li>
        </ul>
      </div><!-- /btn-group -->
    ...
    <div class="section" id="about">
        <div class="container">
            ...
            <div class="col-md-6 about-img-div">
                ...
                <img src="img/mery.png" width="400" class="img-responsive" alt="" align="right" data-aos="fade-right" data-aos-delay="0" />
            </div>
        </div>
    </div>
    <!-- ./about -->
                ...
                <ul class="timeline">
                    ...
                    <li class="timeline-event" data-aos="fade-up" data-aos-delay=".2">
                        ...
                        <div class="timeline-event-copy">
                            ...
                            <h3>FSSM, Marrakech, Maroc</h3>
                            <h4><?= $lang[$_SESSION['language']]['formt2'] ?></h4>
                            <p><strong>Projet fin d'étude de Mars à Mai 2018 </strong><br/>Bibliographie sur les Carbonatites.</p>
                        </div>
                    </li>
                    <li class="timeline-event" data-aos="fade-up" data-aos-delay=".4">
                        <label class="timeline-event-icon"></label>
                        <div class="timeline-event-copy">
                            <p class="timeline-event-thumbnail"><?= $lang[$_SESSION['language']]['date3'] ?></p>
                            <h3>Institut des Mines, Marrakech, Maroc </h3>
                            <h4><?= $lang[$_SESSION['language']]['formt3'] ?> </h4>
                            <p><strong>ONHYM Rabat: Stage PFE de 10 Avril à 10 Juin 2017</strong><br/>Interpretation de lignes sismiques dans la region de SOUSS onshore. </p><br/>
                            <p><strong>OCP Ben Guerir (GANTOUR): Stage initiation de 1 Février à 1 Mars 2016 </strong><br/>Contribution à la reconnaissance geo-minière du P1 mine sud couche 5. </p>
                        </div>
                    </li>
                       <li class="timeline-event" data-aos="fade-up" data-aos-delay=".4">
                        <label class="timeline-event-icon"></label>
    ...
    <div class="section" id="contact">
        <div class="container">
            ...
            <div class="col-md-4" data-aos="fade-up">
                ...
                <p>+212 617 642 527</p>
                <h3>Email</h3>
                <p>meryemeeddoug@gmail.com </p>

                <h3><?= $lang[$_SESSION['language']]['media'] ?></h3>

                <ul class="social">
                    <li><a href="https://www.facebook.com/meryemeeddoug" target="_blank"><i class="ion-social-facebook" ></i></a></li>
                    <li><a href="https://www.instagram.com/meryemeeddoug/" target="_blank"><i class="ion-social-instagram"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/meryeme-eddoug-0186b2173/" target="_blank"><i class="ion-social-linkedin"></i></a></li>
                    <li><a href="https://gitlab.com/MeryemeEdd?nav_source=navbar" target="_blank"><i class="ion-social-github"></i></a></li>
                </ul>
